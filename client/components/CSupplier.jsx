...
const CSupplier = ({ onSupplierCreated }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                ...
                showError(response.message || 'Failed to create supplier');
            }
        } catch (err) {
            showError(err.response?.data?.error || err.message || 'Failed to create supplier');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <>
            ...
            >
                <Icons.Add size={20} /> Create New Supplier
            </button>
                    ...
                    <div style={{
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    <Icons.Success size={16} /> Create Supplier
                                </>
                            )}
                        </button>
                    </div>
